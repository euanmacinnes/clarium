-- information_schema._pg_foreign_data_wrappers source
...
-- information_schema._pg_foreign_servers source
...
-- information_schema._pg_foreign_table_columns source

CREATE OR REPLACE VIEW information_schema._pg_foreign_table_columns
AS SELECT n.nspname,
    c.relname,
    a.attname,
    a.attfdwoptions
...
-- information_schema._pg_foreign_tables source

CREATE OR REPLACE VIEW information_schema._pg_foreign_tables
AS SELECT current_database()::information_schema.sql_identifier AS foreign_table_catalog,
...
-- information_schema._pg_user_mappings source
...
-- information_schema.administrable_role_authorizations source

CREATE OR REPLACE VIEW information_schema.administrable_role_authorizations
AS SELECT applicable_roles.grantee,
...
-- information_schema.applicable_roles source

CREATE OR REPLACE VIEW information_schema.applicable_roles
AS SELECT a.rolname::information_schema.sql_identifier AS grantee,
...
-- information_schema."attributes" source

CREATE OR REPLACE VIEW information_schema."attributes"
AS SELECT current_database()::information_schema.sql_identifier AS udt_catalog,
...
-- information_schema.character_sets source

CREATE OR REPLACE VIEW information_schema.character_sets
AS SELECT NULL::name::information_schema.sql_identifier AS character_set_catalog,
    NULL::name::information_schema.sql_identifier AS character_set_schema,
...
-- information_schema.check_constraint_routine_usage source

CREATE OR REPLACE VIEW information_schema.check_constraint_routine_usage
AS SELECT DISTINCT current_database()::information_schema.sql_identifier AS constraint_catalog,
...
-- information_schema.check_constraints source

CREATE OR REPLACE VIEW information_schema.check_constraints
AS SELECT current_database()::information_schema.sql_identifier AS constraint_catalog,
...
-- information_schema.collation_character_set_applicability source

CREATE OR REPLACE VIEW information_schema.collation_character_set_applicability
AS SELECT current_database()::information_schema.sql_identifier AS collation_catalog,
...
-- information_schema.collations source

CREATE OR REPLACE VIEW information_schema.collations
AS SELECT current_database()::information_schema.sql_identifier AS collation_catalog,
    nc.nspname::information_schema.sql_identifier AS collation_schema,
    c.collname::information_schema.sql_identifier AS collation_name,
...
-- information_schema.column_column_usage source

CREATE OR REPLACE VIEW information_schema.column_column_usage
AS SELECT DISTINCT current_database()::information_schema.sql_identifier AS table_catalog,
...
-- information_schema.column_domain_usage source

CREATE OR REPLACE VIEW information_schema.column_domain_usage
AS SELECT current_database()::information_schema.sql_identifier AS domain_catalog,
...
-- information_schema.column_options source

CREATE OR REPLACE VIEW information_schema.column_options
AS SELECT current_database()::information_schema.sql_identifier AS table_catalog,
...
-- information_schema.column_privileges source

CREATE OR REPLACE VIEW information_schema.column_privileges
AS SELECT u_grantor.rolname::information_schema.sql_identifier AS grantor,
...
-- information_schema.column_udt_usage source
...
-- information_schema.constraint_column_usage source
...
-- information_schema.constraint_table_usage source
...
-- information_schema.data_type_privileges source

CREATE OR REPLACE VIEW information_schema.data_type_privileges
AS SELECT current_database()::information_schema.sql_identifier AS object_catalog,
...
-- information_schema.domain_constraints source
...
-- information_schema.domain_udt_usage source
...
-- information_schema.domains source
...
-- information_schema.element_types source
...
-- information_schema.enabled_roles source

CREATE OR REPLACE VIEW information_schema.enabled_roles
AS SELECT a.rolname::information_schema.sql_identifier AS role_name
   FROM pg_authid a
  WHERE pg_has_role(a.oid, 'USAGE'::text);


-- information_schema.foreign_data_wrapper_options source

CREATE OR REPLACE VIEW information_schema.foreign_data_wrapper_options
AS SELECT w.foreign_data_wrapper_catalog,
...
-- information_schema.foreign_data_wrappers source
...
-- information_schema.foreign_server_options source

CREATE OR REPLACE VIEW information_schema.foreign_server_options
AS SELECT s.foreign_server_catalog,
    s.foreign_server_name,
...
-- information_schema.foreign_servers source

CREATE OR REPLACE VIEW information_schema.foreign_servers
AS SELECT _pg_foreign_servers.foreign_server_catalog,
...
-- information_schema.foreign_table_options source

CREATE OR REPLACE VIEW information_schema.foreign_table_options
AS SELECT t.foreign_table_catalog,
...
-- information_schema.foreign_tables source

CREATE OR REPLACE VIEW information_schema.foreign_tables
AS SELECT _pg_foreign_tables.foreign_table_catalog,
...
-- information_schema.information_schema_catalog_name source

CREATE OR REPLACE VIEW information_schema.information_schema_catalog_name
AS SELECT current_database()::information_schema.sql_identifier AS catalog_name;


-- information_schema.key_column_usage source
...
-- information_schema.parameters source
...
-- information_schema.referential_constraints source
...
-- information_schema.role_column_grants source

CREATE OR REPLACE VIEW information_schema.role_column_grants
AS SELECT column_privileges.grantor,
...
-- information_schema.role_routine_grants source

CREATE OR REPLACE VIEW information_schema.role_routine_grants
AS SELECT routine_privileges.grantor,
...
-- information_schema.role_table_grants source
...
-- information_schema.role_udt_grants source

CREATE OR REPLACE VIEW information_schema.role_udt_grants
AS SELECT udt_privileges.grantor,
...
-- information_schema.role_usage_grants source

CREATE OR REPLACE VIEW information_schema.role_usage_grants
AS SELECT usage_privileges.grantor,
...
-- information_schema.routine_column_usage source

CREATE OR REPLACE VIEW information_schema.routine_column_usage
AS SELECT DISTINCT current_database()::information_schema.sql_identifier AS specific_catalog,
    np.nspname::information_schema.sql_identifier AS specific_schema,
    nameconcatoid(p.proname, p.oid)::information_schema.sql_identifier AS specific_name,
...
-- information_schema.routine_privileges source
...
-- information_schema.routine_routine_usage source

CREATE OR REPLACE VIEW information_schema.routine_routine_usage
AS SELECT DISTINCT current_database()::information_schema.sql_identifier AS specific_catalog,
    np.nspname::information_schema.sql_identifier AS specific_schema,
    nameconcatoid(p.proname, p.oid)::information_schema.sql_identifier AS specific_name,
    current_database()::information_schema.sql_identifier AS routine_catalog,
...
-- information_schema.routine_sequence_usage source

CREATE OR REPLACE VIEW information_schema.routine_sequence_usage
AS SELECT DISTINCT current_database()::information_schema.sql_identifier AS specific_catalog,
    np.nspname::information_schema.sql_identifier AS specific_schema,
    nameconcatoid(p.proname, p.oid)::information_schema.sql_identifier AS specific_name,
    current_database()::information_schema.sql_identifier AS routine_catalog,
...
-- information_schema.routine_table_usage source

CREATE OR REPLACE VIEW information_schema.routine_table_usage
AS SELECT DISTINCT current_database()::information_schema.sql_identifier AS specific_catalog,
    np.nspname::information_schema.sql_identifier AS specific_schema,
    nameconcatoid(p.proname, p.oid)::information_schema.sql_identifier AS specific_name,
    current_database()::information_schema.sql_identifier AS routine_catalog,
...
-- information_schema."routines" source
...
-- information_schema.schemata source
...
-- information_schema."sequences" source

CREATE OR REPLACE VIEW information_schema."sequences"
AS SELECT current_database()::information_schema.sql_identifier AS sequence_catalog,
...
-- information_schema.table_constraints source
...
-- information_schema.table_privileges source
...
-- information_schema."transforms" source
...
-- information_schema.triggered_update_columns source

CREATE OR REPLACE VIEW information_schema.triggered_update_columns
AS SELECT current_database()::information_schema.sql_identifier AS trigger_catalog,
...
-- information_schema.triggers source
...
-- information_schema.udt_privileges source
...
-- information_schema.usage_privileges source

CREATE OR REPLACE VIEW information_schema.usage_privileges
AS SELECT u.rolname::information_schema.sql_identifier AS grantor,
...
-- information_schema.user_defined_types source

CREATE OR REPLACE VIEW information_schema.user_defined_types
AS SELECT current_database()::information_schema.sql_identifier AS user_defined_type_catalog,
...
-- information_schema.user_mapping_options source

CREATE OR REPLACE VIEW information_schema.user_mapping_options
AS SELECT um.authorization_identifier,
...
-- information_schema.user_mappings source

CREATE OR REPLACE VIEW information_schema.user_mappings
AS SELECT _pg_user_mappings.authorization_identifier,
    _pg_user_mappings.foreign_server_catalog,
    _pg_user_mappings.foreign_server_name
   FROM information_schema._pg_user_mappings;


-- information_schema.view_column_usage source

CREATE OR REPLACE VIEW information_schema.view_column_usage
AS SELECT DISTINCT current_database()::information_schema.sql_identifier AS view_catalog,
...
-- information_schema.view_routine_usage source
...
-- information_schema.view_table_usage source
...
-- information_schema."views" source
