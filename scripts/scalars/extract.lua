...
{ "kind": "scalar", "returns": ["number"], "nullable": true, "version": 1,
  "doc": "extract(field, source): extracts a field (year, month, day, hour, minute, second) from a timestamp" }
]]

-- extract(field, source): extracts a specific field from a timestamp
function extract(field, source)
