...
{ "kind": "scalar", "returns": ["string"], "nullable": true, "version": 1,
  "doc": "pg_get_expr(expr_text, relation_oid): returns the text form of an expression (simplified passthrough implementation)" }
]]

-- pg_get_expr(expr_text, relation_oid): returns expression text
...
function pg_get_expr(expr_text, relation_oid)
