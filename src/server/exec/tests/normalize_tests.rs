...
fn test_drop_table_if_exists_normalization() {
    ...
    let result = normalize_query_with_defaults("DROP TABLE IF EXISTS my_table", "timeline", "public");
    assert_eq!(result, "DROP TABLE IF EXISTS timeline/public/my_table");
    
    // Test without IF EXISTS
    let result2 = normalize_query_with_defaults("DROP TABLE my_table", "timeline", "public");
    assert_eq!(result2, "DROP TABLE timeline/public/my_table");
    
    // Test with fully qualified path and IF EXISTS
    let result3 = normalize_query_with_defaults("DROP TABLE IF EXISTS db/schema/table", "timeline", "public");
...
fn test_drop_table_case_insensitive() {
    ...
    let result = normalize_query_with_defaults("drop table my_table", "timeline", "public");
    assert_eq!(result, "DROP TABLE timeline/public/my_table");
    ...
    let result3 = normalize_query_with_defaults("DROP TABLE if exists my_table", "timeline", "public");
    assert_eq!(result3, "DROP TABLE IF EXISTS timeline/public/my_table");
}

#[test]
fn test_drop_table_with_backslash_separator() {
    // Test that backslash-separated paths are converted to forward slashes
    let result = normalize_query_with_defaults("DROP TABLE db\\schema\\table", "timeline", "public");
...
fn test_rename_table_normalization() {
    // Test basic rename
    let result = normalize_query_with_defaults("RENAME TABLE old_table TO new_table", "timeline", "public");
    assert_eq!(result, "RENAME TABLE timeline/public/old_table TO timeline/public/new_table");
    ...
    let result3 = normalize_query_with_defaults("RENAME TABLE db1/schema1/table TO new_table", "timeline", "public");
    assert_eq!(result3, "RENAME TABLE db1/schema1/table TO timeline/public/new_table");
    
    // Test with both qualified
    let result4 = normalize_query_with_defaults("RENAME TABLE db1/schema1/old TO db2/schema2/new", "timeline", "public");
...
fn test_insert_into_normalization() {
    ...
    let result = normalize_query_with_defaults("INSERT INTO my_table VALUES (1, 2)", "timeline", "public");
    assert_eq!(result, "INSERT INTO timeline/public/my_table.time VALUES (1, 2)");
    
    // Test INSERT INTO with column list
    let result2 = normalize_query_with_defaults("INSERT INTO my_table (col1, col2) VALUES (1, 2)", "timeline", "public");
    assert_eq!(result2, "INSERT INTO timeline/public/my_table.time (col1, col2) VALUES (1, 2)");
    
    // Test INSERT INTO with fully qualified table (should still add .time if not present)
    let result3 = normalize_query_with_defaults("INSERT INTO db/schema/table VALUES (1, 2)", "timeline", "public");
    ...
    let result4 = normalize_query_with_defaults("INSERT INTO my_table.time VALUES (1, 2)", "timeline", "public");
    assert_eq!(result4, "INSERT INTO timeline/public/my_table.time VALUES (1, 2)");
}
...
fn test_create_table_normalization() {
    ...
    let result = normalize_query_with_defaults("CREATE TABLE my_table (id INT)", "timeline", "public");
    assert_eq!(result, "CREATE TABLE timeline/public/my_table (id INT)");
    
    // Test CREATE TABLE IF NOT EXISTS
    let result2 = normalize_query_with_defaults("CREATE TABLE IF NOT EXISTS my_table (id INT)", "timeline", "public");
    assert_eq!(result2, "CREATE TABLE IF NOT EXISTS timeline/public/my_table (id INT)");
    
    // Test with fully qualified table
    let result3 = normalize_query_with_defaults("CREATE TABLE db/schema/table (id INT)", "timeline", "public");
...
fn test_delete_normalization() {
    // Test DELETE FROM
    let result = normalize_query_with_defaults("DELETE FROM my_table WHERE id = 1", "timeline", "public");
    assert_eq!(result, "DELETE FROM timeline/public/my_table.time WHERE id = 1");
    
    // Test DELETE FROM with no WHERE clause
    let result2 = normalize_query_with_defaults("DELETE FROM my_table", "timeline", "public");
    assert_eq!(result2, "DELETE FROM timeline/public/my_table.time");
    
    // Test DELETE FROM with fully qualified table
    let result3 = normalize_query_with_defaults("DELETE FROM db/schema/table WHERE id = 1", "timeline", "public");
...
fn test_select_not_normalized() {
    ...
    let result = normalize_query_with_defaults(query, "timeline", "public");
    assert_eq!(result, query);
    
    let query2 = "select col1, col2 from table1 join table2 on table1.id = table2.id";
    let result2 = normalize_query_with_defaults(query2, "timeline", "public");
...
fn test_empty_or_malformed_queries() {
    // Empty string
    let result = normalize_query_with_defaults("", "timeline", "public");
    assert_eq!(result, "");
    
    // Just the command keyword
    let result2 = normalize_query_with_defaults("DROP TABLE", "timeline", "public");
    assert_eq!(result2, "DROP TABLE");
    
    // DROP TABLE IF EXISTS without table name - "IF EXISTS" is treated as the table name
    let result3 = normalize_query_with_defaults("DROP TABLE IF EXISTS", "timeline", "public");
    assert_eq!(result3, "DROP TABLE timeline/public/IF EXISTS");
    
    // RENAME TABLE without TO
    let result4 = normalize_query_with_defaults("RENAME TABLE my_table", "timeline", "public");
    assert_eq!(result4, "RENAME TABLE my_table");
    
    // RENAME TABLE with empty parts
    let result5 = normalize_query_with_defaults("RENAME TABLE TO", "timeline", "public");
...
fn test_whitespace_handling() {
    ...
    let result2 = normalize_query_with_defaults("DROP TABLE IF EXISTS    my_table", "timeline", "public");
    assert_eq!(result2, "DROP TABLE IF EXISTS timeline/public/my_table");
    
    // Tabs between DROP TABLE and table name - function doesn't handle this case, returns unchanged
    let result3 = normalize_query_with_defaults("DROP TABLE\t\tmy_table", "timeline", "public");
...
fn test_special_characters_in_table_names() {
    ...
    let result = normalize_query_with_defaults("DROP TABLE my_test_table", "timeline", "public");
    assert_eq!(result, "DROP TABLE timeline/public/my_test_table");
    
    // Table names with numbers
    let result2 = normalize_query_with_defaults("DROP TABLE table123", "timeline", "public");
    assert_eq!(result2, "DROP TABLE timeline/public/table123");
    
    // Mixed case table names
    let result3 = normalize_query_with_defaults("DROP TABLE MyTable", "timeline", "public");
    assert_eq!(result3, "DROP TABLE timeline/public/MyTable");
}
...
async fn test_drop_table_if_exists_on_nonexistent_table() {
    ...
    let result = execute_query(&store, "DROP TABLE IF EXISTS timeline/public/nonexistent_table").await;
    ...
    let result2 = execute_query(&store, "DROP TABLE timeline/public/another_nonexistent").await;
